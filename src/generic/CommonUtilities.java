...
//			List<WebElement> frameToSelect = new WebDriverTestBase().getDriver().getElements(By.tagName(frameName));
//
//			int flag = 0;
//
...
//		}
		...
		public void switchToFrameByIndex(final String frameName, final int frameIndex) {
			...
			List<WebElement> frameToSelect = (List<WebElement>) webDriver.findElement(By.tagName(frameName));
			try {
		 ...
		 * @throws Exception
		 */
		public void ValidateText_object1_Object2(final WebElement object1, final WebElement object2)
				throws Throwable {
		...
		public void Highlighting_Element(WebDriver qafExtendedWebDriver, WebElement header) throws Exception {
...
//		public WebElement FluientWait(final String Ele, int timeOut) {
//
//			Wait<WebDriver> wait = new FluentWait<WebDriver>(webDriver);
//
//			((FluentWait<WebDriver>) wait).withTimeout(timeOut, TimeUnit.SECONDS)
